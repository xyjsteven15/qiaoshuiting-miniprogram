...
| 规则 | 说明 |
|------|------|
| 人数 ≤10 | 可选中小包间：桥遇厅、羡鱼轩、垂虹居（以各厅后台 `min_guests` / `max_guests` 为准） |
| 人数 >10 | 仅可选大包间（含徽来堂等大厅配置） |
...
| 桥遇厅 | 中小 | ≤10 | — |
| 羡鱼轩 | 中小 | ≤10 | — |
| 垂虹居 | 中小 / 偏大（按实装配置） | ≤10 优先；若后台配置为大包则 >10 可开放 | — |
| 徽来堂 | 大包 + KTV | >10 | 庆典 / 欢唱 |
...
| **包厢探景** | 四厅网格：桥遇厅、羡鱼轩、垂虹居、徽来堂；短视频漫游或 VR/全景 | 徽来堂额外展示 KTV 区；全屏探景时降低 UI 噪音 |
